  ...
  return (
    ...
    >
      ...
      <TabContext value={value}>
        <Box sx={{borderBottom: 1, borderColor: "divider"}} width={"84%"}>
          <TabList
          ...
          >
            <Tab
              ...
              value="1"
              icon={<QueryStatsIcon sx={{color: chartColorsPalette.skyBlue}} />}
              iconPosition="start"
            />
            <Tab
              sx={{color: chartColorsPalette.skyBlue, marginBottom: 1}}
            ...
            <Tab
              ...
              value="3"
              icon={
                <MonetizationOnIcon sx={{color: chartColorsPalette.skyBlue}} />
              }
              iconPosition="start"
            />
            <Tab
              ...
              label="Stop Loss"
              value="4"
              icon={<DangerousIcon sx={{color: chartColorsPalette.skyBlue}} />}
              iconPosition="start"
            />
            <Tab
              sx={{color: chartColorsPalette.skyBlue, marginBottom: 1}}
