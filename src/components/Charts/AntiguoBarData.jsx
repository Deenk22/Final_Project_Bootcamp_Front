...
// export default function BarData({allOperations, selectedStock}) {
//   const [isCompare, setIsCompare] = useState(null);
//   console.log(allOperations);

//   const priceOpen = allOperations?.map((pO) => pO.priceOpen);
//   console.log(priceOpen);
//   const priceClose = allOperations?.map((pC) => pC.priceClose);
