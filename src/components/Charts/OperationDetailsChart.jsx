...
// export default function OperationDetailsChart({operationDetailsInfo}) {
//   const operationKeys = operationDetailsInfo?.map((operation) =>
//     Object.keys(operation)
//   );
//   const operationValues = operationDetailsInfo?.map((operation) =>
